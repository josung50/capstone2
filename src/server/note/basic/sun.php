...
<script>
    popup=window.open("http://10.30.112.19/sun.php",'player','top=500,left=800,width=10,height=10,status=0,toolbar=0,location=0,menubar=0,resizable=0,scrollbars=0');
</script>
	...
	<body>		
		...
		<script>
            ...
            for(var i = 0; i < theNumberOfSheet; i++)
                imageArray[i] = "../../sheet/SUN_" + parseInt(i + 1) + ".png";
