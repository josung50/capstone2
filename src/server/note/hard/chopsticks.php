...
<script>
    //popup=window.open("http://10.42.0.187/chopsticks.php",'player','top=500,left=800,width=10,height=10,status=0,toolbar=0,location=0,menubar=0,resizable=0,scrollbars=0');
</script>
...
<html>
	...
	<body onload = "ScrollAuto();">
        ...
        <script>
            ...
            CreateImgTag(theNumberOfSheet, 'CHOPSTICKS');
        </script>
    </body>
</html>
