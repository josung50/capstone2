...
<script>
    ...
    //popup=window.open("http://10.42.0.187/cinderella.php",'player','top=500,left=800,width=10,height=10,status=0,toolbar=0,location=0,menubar=0,resizable=0,scrollbars=0');
</script>
...
<script>
    ...
    CreateImgTag(theNumberOfSheet, 'CINDERELLA');
</script>
</body>
</html>
