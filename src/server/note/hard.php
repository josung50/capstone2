    	...
    	<section style="height:420px;overflow:none;">
    		<div>
	    		<div class="myclass" style="background-image: url(../image/musicbar.png);background-repeat:round;" width="900px" height="60px">
	    			<span style="font-size: -webkit-xxx-large;" height="90px">캐리비안의 해적</span>
    		...
    		<div>
	    		<div class="myclass" style="background-image: url(../image/musicbar.png);background-repeat:round;" width="900px" height="60px">
	    			...
	    			<a style="float:right;" class="leftrightMargin"  href="./hard/lovebattery.php"><img src="../image/one.png" height="90px" style="z-index:2"></a>
	    		</div>
	    	</div>
